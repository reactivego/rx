...
On first Subscribe it will call Connect on its Connectable and when its last
subscriber is Unsubscribed it will cancel the connection by calling Unsubscribe
on the subscription returned by the call to Connect.
