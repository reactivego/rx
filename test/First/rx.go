...
//jig:name ObservableInt_First

// First emits only the first item, or the first item that meets a condition, from an ObservableInt.
func (o ObservableInt) First() ObservableInt {
	return o.AsObservable().First().AsObservableInt()
}
