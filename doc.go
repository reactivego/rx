...
The implementation in this package is generated by expanding templates from the
"generic" subdirectory on the interface{} type. A function or method parameter
of type interface{} accepts mixed types.
